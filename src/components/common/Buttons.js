...
export const PrimaryButtonMedium = ({ href, icon: Icon, text }) => (
  <Link
    href={href}
    className="block rounded-full min-w-[100px] border-2 border-sky-400 bg-sky-400 px-2.5 py-1.5 text-base text-center font-semibold text-slate-800 shadow-sm hover:bg-sky-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-600"
  >
...
export const LightButtonMedium = ({ href, icon: Icon, text }) => (
  <Link
    href={href}
    className="block rounded-full min-w-[100px] border-2 border-sky-400 bg-transparent px-2.5 py-1.5 text-base text-center font-semibold text-sky-400 shadow-sm hover:bg-sky-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-600"
  >
    <span className="flex justify-center items-center">
      {Icon && (
        <span className="me-2">
...
export const PrimaryButtonSmall = ({ href, icon: Icon, text }) => (
  <Link
    href={href}
    className="block rounded-full border-2 border-sky-400 bg-sky-400 px-2 py-0.5 text-base text-center font-semibold text-slate-800 shadow-sm hover:bg-sky-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-600"
  >
    <span className="flex justify-center items-center">
      {Icon && (
        <span className="me-2">
...
export const LightButtonSmall = ({ href, icon: Icon, text }) => (
  <Link
    href={href}
    className="block rounded-full border-2 border-sky-400 bg-transparent px-2 py-0.5 text-base text-center font-semibold text-sky-400 shadow-sm hover:bg-sky-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-600"
  >
    <span className="flex justify-center items-center">
      {Icon && (
        <span className="me-2">
...
export const SelectionButtonSmall = ({ icon: Icon, text, selected, onClick }) => (
  <button
    ...
    className={`block rounded-full border-2 px-2 text-sm text-center font-semibold shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-slate-800 ${
      selected ? "border-sky-400 bg-sky-400 text-slate-800 hover:bg-sky-500" : "border-slate-100 bg-slate-100 text-slate-800 hover:bg-slate-200"
    }`}
  >
    <span className="flex justify-center items-center">
      {Icon && (
